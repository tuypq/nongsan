    ...
    <div class="tp-banner" >
        <ul>    <!-- SLIDE  -->
            ...
            <li data-transition="random" data-slotamount="6" data-masterspeed="1000" >
                <!-- MAIN IMAGE -->
                <img src="{{ RvMedia::getImageUrl(theme_option('slider_img_1')) }}"  alt="Futurelife-home2-slideshow"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
            ...
            <li data-transition="random" data-slotamount="6" data-masterspeed="1000" >
                <!-- MAIN IMAGE -->
                <img src="{{ RvMedia::getImageUrl(theme_option('slider_img_2')) }}"  alt="Futurelife-home2-slideshow"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
