    ...
    'events' => [
        ...
        'beforeRenderTheme'  => function (Theme $theme) {
            ...
            $theme
                ...
                ->usePath()->add('owl.carousel', 'js/owl.carousel.min.js', ['jquery'], [], '5.11')
                ->usePath()->add('store', 'js/store.js')
                ->usePath()->add('jquery.themepunch.revolution', 'js/jquery.themepunch.revolution.min.js')
                ->usePath()->add('jquery.themepunch.plugins', 'js/jquery.themepunch.plugins.min.js')
                ->usePath()->add('engo-plugins', 'js/engo-plugins.js')
                ->usePath()->add('slick', 'js/slick.min.js')
                ->usePath()->add('jquery.mousewheel.min', 'js/jquery.mousewheel.min.js')
                ->usePath()->add('jquery.lazyimage', 'js/jquery.lazyimage.js')
                ->usePath()->add('jquery.zoom', 'js/jquery.zoom.js')
            ...
            $theme
                ...
                ->usePath()->add('owl-slider', 'css/owl-slider.css')
